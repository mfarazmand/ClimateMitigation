...
Gam20 = load('100yrNewt1b.mat','F1AvgGamhat');
Gam40 = load('100yrNewt1b.mat','F2AvgGamhat');
Gam60 = load('100yrNewt1b.mat','F3AvgGamhat');
Gam80 = load('100yrNewt1b.mat','F4AvgGamhat');
Gam100 = load('100yrNewt1b.mat','AvgGamhat');
...
Temp20 = load('100yrNewt1b.mat','F1AvgThat');
Temp40 =load('100yrNewt1b.mat','F2AvgThat');
Temp60 =load('100yrNewt1b.mat','F3AvgThat');
Temp80 =load('100yrNewt1b.mat','F4AvgThat');
Temp100 =load('100yrNewt1b.mat','AvgThat');
...
Gam120 = load('200yrNewt1b.mat','F3AvgGamhat');
Gam160 = load('200yrNewt1b.mat','F4AvgGamhat');
Gam200 = load('200yrNewt1b.mat','AvgGamhat');
...
Temp120 = load('200yrNewt1b.mat','F3AvgThat');
Temp160 = load('200yrNewt1b.mat','F4AvgThat');
Temp200 = load('200yrNewt1b.mat','AvgThat');
