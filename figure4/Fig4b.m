...
Gam20 = load('100years14B.mat','F1AvgGamhat');
Gam40 = load('100years14B.mat','F2AvgGamhat');
Gam60 = load('100years14B.mat','F3AvgGamhat');
Gam80 = load('100years14B.mat','F4AvgGamhat');
Gam100 = load('100years14B.mat','AvgGamhat');
...
Temp20 = load('100years14B.mat','F1AvgThat');
Temp40 =load('100years14B.mat','F2AvgThat');
Temp60 =load('100years14B.mat','F3AvgThat');
Temp80 =load('100years14B.mat','F4AvgThat');
Temp100 =load('100years14B.mat','AvgThat');
...
Gam120 = load('200years14B.mat','F3AvgGamhat');
Gam160 = load('200years14B.mat','F4AvgGamhat');
Gam200 = load('200years14B.mat','AvgGamhat');
...
Temp120 = load('200years14B.mat','F3AvgThat');
Temp160 = load('200years14B.mat','F4AvgThat');
Temp200 = load('200years14B.mat','AvgThat');
